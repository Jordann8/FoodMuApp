...
class FoodItemAdapter(val context : Context, val listModel: ArrayList<MakananModel>): RecyclerView.Adapter<FoodItemAdapter.ViewHolderMakanan>() {

    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolderMakanan {
        val inflater = LayoutInflater.from(context)

        val view = inflater.inflate(R.layout.item_row_food, viewGroup, false)
